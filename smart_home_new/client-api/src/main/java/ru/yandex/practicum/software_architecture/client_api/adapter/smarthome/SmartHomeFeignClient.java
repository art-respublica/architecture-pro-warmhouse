...
public interface SmartHomeFeignClient {
    ...
    @GetMapping("/users/{id}")
    Sensor getUserById(@PathVariable("id") String id);
    ...
    @PutMapping("/users/{id}")
    Sensor updateUser(@PathVariable("id") String id, @RequestBody User user);

    @DeleteMapping("/users/{id}")
    Sensor deleteUser(@PathVariable("id") String id);
}
